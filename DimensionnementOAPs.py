...
" Parameters"
DEG2RAD = np.pi/180;
#theta  = 15*DEG2RAD;	#[rad]  pour l'OAP0
...
# PFL_OAP0_demi =(DDM/2)/2/(-1/tan(theta+alpha)+(1/(tan(theta+alpha))**2+1)**0.5+1/tan(theta)-(1/(tan(theta))**2+1)**0.5)   #[mm] pour l'OAP0
...
# # pour l'OAP1
# fOAP1 = 430;            #[mm]
# alpha = atan(DDM*0.5/fOAP1);    #[rad] 
# PFL_OAP1 =(DDM/2)/2/(-1/tan(theta_OAP1+alpha)+(1/(tan(theta_OAP1+alpha))**2+1)**0.5+1/tan(theta_OAP1)-(1/(tan(theta_OAP1))**2+1)**0.5);   #[mm] pour l'OAP1
# EFL_OAP1 = 2*PFL_OAP1/(1+cos(theta_OAP1));
# 
# 
# # pour l'OAP2
# TTangle = 10*DEG2RAD;
# DTT = 25.4*cos(TTangle);            #[mm]
# fOAP2 = DTT/DDM*fOAP1;     #[-]
